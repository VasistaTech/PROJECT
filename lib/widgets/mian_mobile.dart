        ...
        const url = 'https://github.com/VasistaTech/PROJECT/blob/main/public/b.pdf?raw=true'; // The relative path to your PDF in the web directory

        final anchor = html.AnchorElement(href: url)

        ..setAttribute('download', 'b.pdf') // Name of the downloaded file
